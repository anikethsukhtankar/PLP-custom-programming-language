...
//		show(program);  //It may be useful useful to show this here if code generation fails
	...
	public void floatLit() throws Exception {
		...
		String input = prog + "{show 3.14;} ";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;3.14;leaving main;",RuntimeLog.globalLog.toString());
	}
	
	@Test
	public void testWhile() throws Exception {
		String prog = "prog";
		String input = prog + "{int y; y:=0; while(y<5){show y; y:=y+1;};}";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
	...
	public void testIf() throws Exception {
		String prog = "prog";
		String input = prog + "{int y; y:=5; if(y<6){show y; y:=y+1;}; show y;}";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;5;6;leaving main;",RuntimeLog.globalLog.toString());
	}
	
	@Test
	public void testFloatCompare() throws Exception {
		String prog = "prog";
		String input = prog + "{float y; y:=3.14; float z; z:=3.14; if(y<z){show 1;}; if(y<=z){show 2;}; if(y>z){show 3;}; if(y>=z){show 4;}; if(y==z){show 5;}; if(y!=z){show 6;};}";	
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
		assertEquals("entering main;2;4;5;leaving main;",RuntimeLog.globalLog.toString());
	}
